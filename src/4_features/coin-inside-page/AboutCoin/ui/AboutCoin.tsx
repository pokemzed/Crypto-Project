            ...
            {coinInfo && (
                <div className={"about-crypto_container"}>
                    <div className={"coin-info"}>
                        <span className={"rank"}>Rank #{coinInfo.coingecko_rank}</span>
                        <div className={"coin"}>
                    ...
                    <div className={"price-info"}>
                        <div className={"price"}>
                            <h2>${coinInfo.market_data.current_price.usd.toLocaleString('en-IN')}</h2>
                            <span>1.00000000 {coinInfo.symbol.toUpperCase()}</span>
                        </div>
                        <div className={"chart-price"}>
                            <div className={"chart"}>
                                <div className={"inside-line"} style={{width: `${coinInfo.coingecko_score}%`}}></div>
                            </div>
                            <div className={"chart-stats"}>
                                <span>${coinInfo.market_data.low_24h.usd.toLocaleString('en-IN')}</span>
                                <span>24H Range</span>
                                <span>${coinInfo.market_data.high_24h.usd.toLocaleString('en-IN')}</span>
                            </div>
                        </div>
                    </div>
